{ title:        "The Problem with Being a T-girl on the Side", 
  slug:         "the-problem-with-being-a-tgirl-on-the-side", 
  published_at: Time.parse("November 14, 2011  9:41 MST"), 
  tiny_slug:    "side-tgirl",
  location:     "in (a rarely sunny) Amsterdam", 
  hidden:       "true",
  summary:      <<-eos
